			...
			function ()
			{
				...
				p[ "addMarker" ] = function ( marker )
				{
					...
					if ( !this[ "markersWontHide" ] ) {
						listenerRefs.push (
							ge.addListener (
								marker, "visible_changed", function ()
								{
				...
				p.markerChangeListener = function ( marker, positionChanged )
				{
					if ( (
						...
						(
						this.spiderfying != null
						) || (
						this.unspiderfying != null
						)
						) ) {
				...
				p[ "addListener" ] = function ( event, func )
				{
					...
					(
						(
							_ref2 = (
								_base = this.listeners
							)[ event ]
						) != null ? _ref2 : _base[ event ] = []
					).push ( func );
					return this;
				};
				...
				p.generatePtsCircle = function ( count, centerPt )
				{
					...
					circumference = this[ "circleFootSeparation" ] * (
						2 + count
						);
				...
				p.spiderListener = function ( marker, event )
				{
					...
					if ( !(
						markerSpiderfied && this[ "keepSpiderfied" ]
						) ) {
						this[ "unspiderfy" ] ();
					}
					...
					for ( _j = 0, _len1 = _ref2.length; _j < _len1; _j++ ) {
						...
						mPt = this.llToPt (
							(
								_ref3 = (
								_ref4 = m[ "_omsData" ]
							) != null ? _ref4.usualPosition : void 0
							) != null ? _ref3 : m.position
						);
						if ( this.ptDistanceSq ( mPt, markerPt ) < pxSq ) {
							markers.push ( m );
							if ( firstOnly ) {
				...
				p.minExtract = function ( set, func )
				{
					...
					for ( index = _j = 0, _len1 = set.length; _j < _len1; index = ++_j ) {
						...
						val  = func ( item );
						if ( (
						     typeof bestIndex === "undefined" || bestIndex === null
						     ) || val < bestVal ) {
							bestVal   = val;
							bestIndex = index;
						}
