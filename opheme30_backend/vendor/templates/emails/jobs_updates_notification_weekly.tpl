<p style="color: #606060;font-family: Helvetica;font-size: 15px;line-height: 150%;text-align: left;">
	...
	<br>
	<br>
	Here's a recap of what {$Data.email.brand}'s been up to this past week on your behalf:
	<br>
</p>
{if isset($Data.email.jobs)}
	<table style="color: #000000; margin-left: auto; margin-right: auto; border: 0px; font-family: Helvetica; font-size: 15px; line-height: 150%; text-align: center;">
		<thead>
			<tr>
				<th style="padding: 5px;">Tasks of Type</th>
				<th style="padding: 5px;">Total New Messages</th>
			</tr>
		</thead>
		<tbody>
			{foreach $Data.email.jobs as $jobType => $job}
				<tr>
					<td style="padding: 5px;">{ucfirst($jobType)}</td>
